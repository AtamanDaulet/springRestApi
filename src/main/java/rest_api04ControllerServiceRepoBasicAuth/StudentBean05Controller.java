...
public class StudentBean05Controller {
	...
	@PreAuthorize("hasAnyRole('ROLE_ADMIN', 'ROLE_STUDENT')")
	public StudentBean05 getStudentById(@PathVariable (value = "id") Long id){
    ...
    @PreAuthorize("hasAuthority('student:write')")  //students05
    ...
    @PreAuthorize("hasAuthority('student:write')")
    public StudentBean05 postStudent(@Validated @RequestBody StudentBean05 newStudent) {
        try {
